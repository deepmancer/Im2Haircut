...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.trainable_cameras = False
        self.trainable_intrinsics = False
        self.use_barf = False
        self.flame_mesh_dir = ""
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.lambda_dreg = 0.0
        
        # Strands reconstruction args
        self.lambda_dchamp = 0.0
        self.lambda_dchamn = 0.0
        self.lambda_dchamf = 0.0

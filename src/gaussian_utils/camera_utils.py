...
import sys
sys.path.append("./submodules/external/GaussianHaircut/src")
...
#         print(' i am in gs and check onf', resized_orient_conf.max(), resized_orient_conf.min())
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T,
                  FoVx=cam_info.FovX, FoVy=cam_info.FovY, cx=cam_info.cx, cy=cam_info.cy, width=cam_info.width, height=cam_info.height,
